...
class _AprilPageState extends State<AprilPage> {
  ApiApril _apiApril = ApiApril();
  late Map<String, dynamic> _AprilData;
  ...
  Future<void> _fetchAprilData() async {
    try {
      _AprilData = await _apiApril.fetchAprilData();
     _filteredGameList.addAll(_AprilData.entries
