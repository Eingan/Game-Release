...
class _MayPageState extends State<MayPage> {
  ApiMay _apiMay = ApiMay();
  late Map<String, dynamic> _MayData;
  ...
  Future<void> _fetchMayData() async {
    try {
      _MayData = await _apiMay.fetchMayData();
     _filteredGameList.addAll(_MayData.entries
