...
class JanuaryPage extends StatefulWidget {
  @override
  State<JanuaryPage> createState() => _JanuaryPageState();
}

class _JanuaryPageState extends State<JanuaryPage> {
  ApiJanuary _apiJanuary = ApiJanuary();
  late Map<String, dynamic> _JanuaryData;
  ...
  Future<void> _fetchJanuaryData() async {
    try {
      _JanuaryData = await _apiJanuary.fetchJanuaryData();
     _filteredGameList.addAll(_JanuaryData.entries
