...
class _MarchPageState extends State<MarchPage> {
  ApiMarch _apiMarch = ApiMarch();
  late Map<String, dynamic> _MarchData;
  ...
  Future<void> _fetchMarchData() async {
    try {
      _MarchData = await _apiMarch.fetchMarchData();
     _filteredGameList.addAll(_MarchData.entries
