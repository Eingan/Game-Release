...
class _NovemberPageState extends State<NovemberPage> {
  ApiNovember _apiNovember = ApiNovember();
  late Map<String, dynamic> _NovemberData;
  ...
  Future<void> _fetchNovemberData() async {
    try {
      _NovemberData = await _apiNovember.fetchNovemberData();
     _filteredGameList.addAll(_NovemberData.entries
