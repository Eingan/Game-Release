...
class _JulyPageState extends State<JulyPage> {
  ApiJuly _apiJuly = ApiJuly();
  late Map<String, dynamic> _JulyData;
  ...
  Future<void> _fetchJulyData() async {
    try {
      _JulyData = await _apiJuly.fetchJulyData();
     _filteredGameList.addAll(_JulyData.entries
