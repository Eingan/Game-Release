...
class FebruaryPage extends StatefulWidget {
  @override
  State<FebruaryPage> createState() => _FebruaryPageState();
}

class _FebruaryPageState extends State<FebruaryPage> {
  ApiFebruary _apiFebruary = ApiFebruary();
  late Map<String, dynamic> _februaryData;
  ...
  Future<void> _fetchFebruaryData() async {
    try {
      _februaryData = await _apiFebruary.fetchFebruaryData();
     _filteredGameList.addAll(_februaryData.entries
