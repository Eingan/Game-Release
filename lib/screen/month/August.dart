...
class _AugustPageState extends State<AugustPage> {
  ApiAugust _apiAugust = ApiAugust();
  late Map<String, dynamic> _AugustData;
  ...
  Future<void> _fetchAugustData() async {
    try {
      _AugustData = await _apiAugust.fetchAugustData();
     _filteredGameList.addAll(_AugustData.entries
