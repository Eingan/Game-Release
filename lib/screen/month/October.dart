...
class _OctoberPageState extends State<OctoberPage> {
  ApiOctober _apiOctober = ApiOctober();
  late Map<String, dynamic> _OctoberData;
  ...
  Future<void> _fetchOctoberData() async {
    try {
      _OctoberData = await _apiOctober.fetchOctoberData();
     _filteredGameList.addAll(_OctoberData.entries
