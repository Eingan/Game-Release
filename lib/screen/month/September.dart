...
class _SeptemberPageState extends State<SeptemberPage> {
  ApiSeptember _apiSeptember = ApiSeptember();
  late Map<String, dynamic> _SeptemberData;
  ...
  Future<void> _fetchSeptemberData() async {
    try {
      _SeptemberData = await _apiSeptember.fetchSeptemberData();
     _filteredGameList.addAll(_SeptemberData.entries
