...
class JunePage extends StatefulWidget {
  @override
  State<JunePage> createState() => _JunePageState();
}

class _JunePageState extends State<JunePage> {
  ApiJune _apiJune = ApiJune();
  late Map<String, dynamic> _JuneData;
  ...
  Future<void> _fetchJuneData() async {
    try {
      _JuneData = await _apiJune.fetchJuneData();
     _filteredGameList.addAll(_JuneData.entries
